...
namespace Peliculas.Entidades.Seeding
{
    internal class SeedingPeliculas
    {
        internal static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Pelicula>().HasData(pelicula1, pelicula2, pelicula3, pelicula4, pelicula5, pelicula6, pelicula7, pelicula8, pelicula9);
            ...
            var cine1CineOferta = new CineOferta { Id = 10, CineId = cine1.Id, FechaInicio = DateTime.Today.AddDays(5), FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 8 };
            var cine2CineOferta = new CineOferta { Id = 11, CineId = cine2.Id, FechaInicio = DateTime.Today.AddDays(5), FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 10 };
            var cine3CineOferta = new CineOferta { Id = 12, CineId = cine3.Id, FechaInicio = DateTime.Today.AddDays(5), FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 12 };
            var cine4CineOferta = new CineOferta { Id = 13, CineId = cine4.Id, FechaInicio = DateTime.Today.AddDays(5), FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 15 };
            var cine5CineOferta = new CineOferta { Id = 14, CineId = cine5.Id, FechaInicio = DateTime.Today.AddDays(5), FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 20 };
            ...
            var salaDeCine1 = new SalasCine()
            {
                Id = 1,
                Nombre = "Sala 1",
                Tipo = (int)EnumTipoSalaDeCine.TresDimensiones,
                CineId = 4
            };

            var salaDeCine2 = new SalasCine()
            {
                Id = 2,
                Nombre = "Sala 2",
                Tipo = (int)EnumTipoSalaDeCine.DosDimensiones,
                CineId = 4
            };

            var salaDeCine3 = new SalasCine()
            {
                Id = 3,
                Nombre = "Sala 3",
                Tipo = (int)EnumTipoSalaDeCine.DosDimensiones,
            ...
            modelBuilder.Entity<SalasCine>().HasData(salaDeCine1, salaDeCine2, salaDeCine3);
