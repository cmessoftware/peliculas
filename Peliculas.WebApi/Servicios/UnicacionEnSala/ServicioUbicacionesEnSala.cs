...
namespace Peliculas.Servicios
{
    public class ServicioUbicacionesEnSala : IServicioUbicacionesEnSala
    {
        ...
        public async Task<bool> Create(UbicacionesEnSala ubicacionEnSala)
        {
        ...
        public async Task<List<UbicacionesEnSala>> GetAll()
        {
            var ubicacionesEnSala = await _unitOfWork.UbicacionesEnSala.GetAll();
            return ubicacionesEnSala;
        }

        public async Task<UbicacionesEnSala> GetById(int? id)
        {
            if (id != null)
            {
        ...
        public async Task<bool> Update(UbicacionesEnSala ubicacionEnSala)
        {
            if (ubicacionEnSala != null)
            {
