...
namespace Peliculas.Entidades.Seeding
{
    internal class SeedingModuloConsulta
    {
        internal static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var salaDeCine1 = new SalaDeCine()
            {
                Id = 1,
                Nombre = "Sala 1",
                Tipo = TipoSalaDeCine.TresDimensiones,
                CineId = 4
            };

            var salaDeCine2 = new SalaDeCine()
            {
                Id = 2,
                Nombre = "Sala 2",
                Tipo = TipoSalaDeCine.DosDimensiones,
                CineId = 4
            };

            var salaDeCine3 = new SalaDeCine()
            {
            ...
            modelBuilder.Entity<SalaDeCine>().HasData(salaDeCine1, salaDeCine2, salaDeCine3);
            ...
            modelBuilder.Entity<Pelicula>().HasData(critica1,critica2);
