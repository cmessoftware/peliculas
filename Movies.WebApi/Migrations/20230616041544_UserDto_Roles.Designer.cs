...
namespace Movies.WebApi.Migrations
{
    ...
    [Migration("20230616041544_UserDto_Roles")]
    partial class UserDto_Roles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActorMovie", b =>
                {
                    ...
                    b.HasIndex(new[] { "MoviesId" }, "IX_ActorMovie_MoviesId");
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.Address", b =>
                {
                    b.HasOne("Peliculas.WebApi.Entities.User", null)
                        .WithMany("Addresses")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.Comments", b =>
                {
                    b.HasOne("Peliculas.WebApi.Entities.User", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.Role", b =>
                {
                    b.HasOne("Peliculas.WebApi.Entities.UserLogin", null)
                        .WithOne("Role")
                        .HasForeignKey("Peliculas.WebApi.Entities.Role", "UserLoginId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.User", b =>
                {
                    b.HasOne("Peliculas.WebApi.Entities.UserLogin", "UserLogin")
                        .WithMany()
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.UserLogin", b =>
                {
                    b.HasOne("Peliculas.WebApi.Entities.Address", null)
                        .WithMany("Users")
