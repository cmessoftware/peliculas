...
namespace Movies.WebApi.Migrations
{
    ...
    [Migration("20230619022049_Extend_EFCore.Identity")]
    partial class Extend_EFCoreIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.MovieRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.MovieUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("MovieUser");
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.Client", b =>
                {
                    b.HasBaseType("Peliculas.WebApi.Entities.MovieUser");
            ...
            modelBuilder.Entity("Peliculas.WebApi.Entities.MovieRole", b =>
                {
                    b.HasOne("Peliculas.WebApi.Entities.MovieUser", null)
                        .WithMany("MovieUserRoles")
