...
namespace Movies.WebApi.Controllers
{
    ...
    public class CriticController : ControllerBase
    {
        ...
        private readonly IGenericMapper<CriticaDto, Critics> _criticasMapper;

        public CriticController(IMapper mapper,
                                  IServicioCriticas servicioCriticas,
                                  IGenericMapper<CriticaDto, Critics> criticasMapper
                                  )
        {
            _mapper = mapper;
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                var acciones = Utils.GetActions("Criticas", null);
        ...
        public async Task<IActionResult> Create([FromBody] CriticaRequestDto criticasVM)
        {
            try
            {
                ...
                {
                    var criticas = _mapper.Map<Critics>(criticasVM);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    var critica = _mapper.Map<Critics>(id);
