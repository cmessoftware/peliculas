...
namespace Movies.Servicios
{
    public class ServicioCriticas : IServicioCriticas
    {
        ...
        public async Task<bool> Create(Critics critica)
        {
            if (critica != null)
            {
        ...
        public async Task<Critics> GetById(int? id)
        {
            if (id > 0)
            {
        ...
        public async Task<bool> Update(Critics critica)
        {
            if (critica != null)
            {
                ...
                if (criticaDB != null)
                {
                    criticaDB.Content = critica.Content;
